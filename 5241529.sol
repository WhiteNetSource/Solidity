...
contract ADDRESS {
    ...
    function getBalance( address _n ) public view returns( uint ) {
        return _n.balance;
    }

    function getCode( address _n ) public view returns( bytes memory ) {
        return _n.code;
    }

    function getCodeHash( address _n ) public view returns( bytes32 ) {
        return _n.codehash;
    }

    function transferAsset( address payable _n ) public {
        _n.transfer( 100 );
    }

    function sendAsset( address payable _n ) public returns( bool ) {
        return _n.send( 100 );
    }
